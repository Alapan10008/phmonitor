...
import 'package:phmonitor/reset_password.dart';
import 'package:phmonitor/signup_screen.dart';
import 'package:phmonitor/social_icon.dart';
import 'package:phmonitor/utils/constants.dart';
          ...
          child: Padding(
            ...
            child: Column(
              children: <Widget>[
                ...
                Center(
                    child: Image.asset("assets/images/logo-no-background4.png", fit: BoxFit.fill,
                      height: height*0.2,
                      width: height*0.3,
                      )),
                SizedBox(
